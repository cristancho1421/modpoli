...
<div class="module-head"> 
	<h1 class="page-header">Lista de preguntas <a href="index.php?view=add" class="btn btn-primary">Nueva</a> </h1> 
		</div> 
			...
			<table id="example" class=" datatable-1 table table-bordered table-hover" cellspacing="0" style="font-size:12px" >
				...
				<?php  
					...
					echo '<td > <a title="Edit" href="index.php?view=edit&id='.$result->ExerciseID.'" class="btn btn-primary btn-xs" >Editar</a>
									<a title="Delete" href="controller.php?action=delete&id='.$result->ExerciseID.'" class="btn btn-danger btn-xs" >Borrar</a>
									</td>';
					echo '</tr>';
				} 
				?>
